amoto=audioread("260604_0026.wav");
fs=192000;
% ▼ 区間中央のWAV時刻[秒]。録音はスクリプトより約10秒先行（offset=+10s）。
%   kijun=160  HOLD1=460  p3slow=760  p4avg=1060  gentle=1360
tc_s = 160;            % ← この数字を上の5つに変えて5回実行
start=10000+tc_s*fs;
hani=(start+1):(start+fs*10+20000);
amoto2=amoto(hani,:);
