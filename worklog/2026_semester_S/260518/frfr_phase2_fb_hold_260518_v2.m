function result = frfr_phase2_fb_hold_260518_v2(t_total, FRFR_ref, t_fb_end, t_hold_end)
%====================================================================
...
%
% デフォルト（260518 v2: 10 分計測, 5 分制御 + 5 分 HOLD）:
%   t_fb_end   = 300 s ( 5 分)
...
%====================================================================
    ...
    fprintf("=== Phase 2 FB+HOLD 開始 (ao0 単独, 260518 v2) ===\n");
