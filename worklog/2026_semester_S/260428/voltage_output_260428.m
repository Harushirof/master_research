function result = voltage_output_260428(ao0_V, ao1_V, hold_s)
%====================================================================
% 電圧出力ユーティリティ
%
...
%
% 使い方:
%   voltage_output_260428()                    % 既定値で実行
%   voltage_output_260428(2.5, 2.5, 5)         % ao0=2.5V, ao1=2.5V, 5秒
%   voltage_output_260428(1.54, 1.64, 10)      % 動作テスト用
%
% 引数:
